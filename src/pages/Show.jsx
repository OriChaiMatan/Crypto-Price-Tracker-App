     ...
     <div>
      ...
      {store.data && <>
       ...
       <div className="show-details">
        ...
        <div className='show-details-row'>
            <h3>Current price</h3>
            <span>${store.data.market_data.current_price.usd.toLocaleString()}</span>
        </div>
        <div className='show-details-row'>
        ...
        <div className='show-details-row'>
            ...
            <span>${store.data.market_data.high_24h.usd.toLocaleString()}</span>
        </div>
        <div className='show-details-row'>
            <h3>24h low price</h3>
            <span>${store.data.market_data.low_24h.usd.toLocaleString()}</span>
        </div>
        <div className='show-details-row'>
